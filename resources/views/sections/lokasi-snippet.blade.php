        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="reveal">
                ...
                <h2 class="font-['Outfit'] text-3xl md:text-[40px] font-semibold leading-tight tracking-tight mb-5">
                    Temukan Kalurahan Melikan
                </h2>
                <p class="text-[17px] leading-relaxed text-[#6E6E73] mb-8">
                    Kalurahan Melikan berada di Kapanewon Rongkop, Kabupaten Gunungkidul, D.I. Yogyakarta. Lokasi desa mudah dijangkau dari arah Kota Wonosari maupun dari arah Pracimantoro, Wonogiri.
                </p>

                <div class="space-y-4 mb-8">
                    <div class="flex items-center gap-3">
                        <span class="w-2.5 h-2.5 bg-[#2D5F5D] rounded-full"></span>
                        <span class="text-[15px] font-medium text-[#333336]">55884 (Kode Pos Kalurahan)</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <span class="w-2.5 h-2.5 bg-[#2D5F5D] rounded-full"></span>
                        <span class="text-[15px] font-medium text-[#333336]">Kapanewon Rongkop, Kabupaten Gunungkidul</span>
                    </div>
                </div>
            ...
            <div class="relative reveal reveal-delay-2 cursor-pointer group" onclick="window.location.href='/lokasi'">
                <div class="overflow-hidden border border-[#E8E5DE] aspect-[16/10] bg-[#E8F0EF] flex items-center justify-center relative rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-200">
                    {{-- Minimalist map background style --}}
                    ...
                    <div class="text-center p-8 z-10">
                        ...
                        <p class="text-sm text-[#6E6E73]">Lihat letak Kalurahan Melikan via Google Maps</p>
                    </div>
                </div>
            </div>
